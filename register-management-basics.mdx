...
description: >-
  Conceptual overview of register sessions, cash drawers, terminals, and why
  opening and closing registers matter for daily reconciliation.
---
...
<Columns cols="3">
  <Card title="Payment Solutions" href="/payment-solutions" icon="package" horizontal="false">
    Learn how Punchey accepts cash, card, and remote payments.
  </Card>

  <Card title="How Money Moves with Punchey" href="/money-flow" icon="box" horizontal="false">
    Follow the flow from transaction to bank deposit.
  </Card>

  <Card title="Devices & Readers" href="/devices-and-readers" icon="cpu" horizontal="false">
    See how terminals and readers connect to your checkout workflow.
  </Card>

  <Card title="Team & Locations" href="/team-and-locations" icon="users" horizontal="false">
    Understand staffing, permissions, and checkout stations.
  </Card>

  <Card title="Reports" href="/reports" icon="clock" horizontal="false">
